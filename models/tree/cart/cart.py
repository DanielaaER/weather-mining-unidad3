...
clf = DecisionTreeClassifier(criterion='gini', ccp_alpha=0.0, min_samples_leaf=2, random_state=42)
...
print(f"ROC AUC promedio (macro): {roc_auc:.4f}\n")
